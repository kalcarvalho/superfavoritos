...
$pe = $pd->findByOferta($p2);

// Criando um novo carrinho
$pgs = new pgs(array('email_cobranca' => 'pagamento@superfavoritos.com.br'));
$descricao = trim($pe->getTitulo());
$preco = $pe->getValor();
$qtde = $pe->getQuantidade();
$id_pagseguro = $pe->getPagSeguro();
...
<div class="content">
	<div class="painel-cliente">
		...
		echo '<h4>Valor a pagar: R$ ' . number_format($preco * $qtde, 2, ',', '') . ' (' . $qtde . ' cupom(ns))</h4>';
